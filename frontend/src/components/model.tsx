...
const useOutsideClick = (callback: () => void) => {
  ...
  export function Model({
    ...
    return (
      ...
      className="w-1/2 absolute z-10 left-80 top-10" ref={ref}>
        <div className="flex flex-col justify-center items-center gap-4 border border-border rounded-[10px] p-10 bg-[rgba(255, 255, 255, 0.15)] backdrop-blur-2xl shadow-glass w-full">
